...
class BookDetailsViewController: UIViewController {
    ...
    @IBAction func buttonCheckOutClicked(_ sender: Any) {
        ...
        { [unowned self] (controller, result, error) in
            ...
            if let error = error {
                ...
                self.sendRequestPaymentToServer(nonce: nonce, amount: amount, firstName: "Harrison", lastName: "Chin", email: "harrison.chin@taqtik.com")
            }
    ...
    func sendRequestPaymentToServer(nonce: String, amount: String, firstName: String, lastName: String, email: String) {
        ...
        //        let paymentURL = URL(string: "http://localhost:3000/api/braintreepay")!
